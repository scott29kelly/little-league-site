...
Use this as a short screen-share path for the Middletown-Neshaminy Baseball demo. Keep the tone practical: this is a public website families could actually use while official registration and records stay in Sports Connect.
...
"This site gives families one clear place to start: register, check the schedule, find a field, see game-day updates, browse photos, and contact the league."

## Two-Minute Walkthrough

1. Start with the hero.
   "The first screen identifies the league, explains who it serves, and gives parents the two most common actions: register or view schedule and fields."

2. Point to quick actions.
